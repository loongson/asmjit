...
#ifndef ASMJIT_LOONG_LOONGEMITHELPER_P_H_INCLUDED
#define ASMJIT_LOONG_LOONGEMITHELPER_P_H_INCLUDED
...
#endif // ASMJIT_LOONG_LOONGEMITHELPER_P_H_INCLUDED
