...
#ifndef ASMJIT_LOONG_LA64UTILS_H_INCLUDED
#define ASMJIT_LOONG_LA64UTILS_H_INCLUDED
...
//! +---+--------+--------+------+
//! ```
static bool encodeLogicalImm(uint64_t imm, uint32_t width, la64::Utils::LogicalImm* out) noexcept {
...
#endif // ASMJIT_LOONG_LA64UTILS_H_INCLUDED
