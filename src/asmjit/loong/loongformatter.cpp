...
//ASMJIT_BEGIN_SUB_NAMESPACE(loongarch)
// ============================================================================
...
Error FormatterInternal::formatFeature(String& sb, uint32_t featureId) noexcept {
  ...
  return sb.append(sFeatureString + sFeatureIndex[Support::min<uint32_t>(featureId, loong::Features::kCount)]);
}
...
ASMJIT_FAVOR_SIZE Error FormatterInternal::formatShiftOp(String& sb, uint32_t shiftOp) noexcept {
  ...
  switch (shiftOp) {
    case loongShift::kOpLSL: str = "lsl"; break;
    case loongShift::kOpLSR: str = "lsr"; break;
    case loongShift::kOpASR: str = "asr"; break;
    case loongShift::kOpROR: str = "ror"; break;
    case loongShift::kOpRRX: str = "rrx"; break;
    case loongShift::kOpUXTB: str = "uxtb"; break;
    case loongShift::kOpUXTH: str = "uxth"; break;
    case loongShift::kOpUXTW: str = "uxtw"; break;
    case loongShift::kOpUXTX: str = "uxtx"; break;
    case loongShift::kOpSXTB: str = "sxtb"; break;
    case loongShift::kOpSXTH: str = "sxth"; break;
    case loongShift::kOpSXTW: str = "sxtw"; break;
    case loongShift::kOpSXTX: str = "sxtx"; break;
  }
...
// ============================================================================
// [asmjit::loong::FormatterInternal - Format Operand]
// ============================================================================
...
ASMJIT_FAVOR_SIZE Error FormatterInternal::formatInstruction(
  ...
  if (Environment::isFamilyLOONGARCH(arch)) {
    ...
    if (instId < la64::Inst::_kIdCount)
      ASMJIT_PROPAGATE(InstAPI::instIdToString(arch, instId, sb));
    else
      ASMJIT_PROPAGATE(sb.appendFormat("[InstId=#%u]", unsigned(instId)));

    if (inst.hasOption(la64::Inst::kOptionCondFlagMask)) {
      ASMJIT_PROPAGATE(sb.append('.'));
      ASMJIT_PROPAGATE(formatCondCode(sb, inst.options() >> la64::Inst::kOptionCondCodeShift));
    }
  }
  else {
    // TODO: [ARM] 32-bit LOONG support.
  }
